...
const LatestProducts = () => {
    ...
    const getlatestProducts = async () => {
        try {
            const { success, data } = await axios.get("/home/latest-products");
            if (success && data) {
            ...
            console.log(error.message || "Failed to fetch latest products");
            setProducts([]);
        }
    }
    // Fetch Latest Products from API Section End

    // Fetch latest products on component mount Section Start
    useEffect(() => {
        getlatestProducts();
    }, []);
    // Fetch latest products on component mount Section End
