...
const CreateCategory = () => {
  ...
  const saveCategory = async (formdata) => {
    setLoading(true);
    try{
     const {success, message, data}  = await axios.post("/admin/categories/create", formdata);
     if(success){
            ...
            <div className="p-3">
              <form className="space-y-4" onSubmit={handleSubmit(saveCategory)}>
                ...
                <div className="flex flex-col">
                  ...
                  <select {...register("status", { required: "Status field is required" })}  className="border border-gray-200 px-3 py-2 mt-1 rounded focus:outline-none focus:ring-1 focus:ring-blue-600">
                ...
                <button disabled={loading} className="bg-green-500 text-white px-4 py-1.5 rounded-md mt-3 cursor-pointer">
